...
namespace geocuda {
namespace math {
template <typename T> CUDA_HOST_DEVICE_INLINE T sq(T x) { return x * x; }
...
template <typename T> CUDA_HOST_DEVICE_INLINE static inline T latfix(T x) { return abs(x) > 90.0 ? nan("") : x; }
...
**********************************************************************/
template <typename T> CUDA_HOST_DEVICE_INLINE static inline T atand(T x) { return atan2d(x, T(1)); }
...
**********************************************************************/
CUDA_HOST_DEVICE_INLINE static inline double degree() { return M_PI / 180; }
