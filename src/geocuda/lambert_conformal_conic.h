...
* AlbersEqualArea.
**********************************************************************/
class GEOCUDA_API LambertConformalConic {
private:
    ...
    const int numit_ = 5;
    CUDA_HOST_DEVICE static inline double hyp(double x) { return hypot(double(1), x); }
    // Divided differences
...
public:
    ...
    **********************************************************************/
    CUDA_HOST_DEVICE LambertConformalConic(double a, double f,
    ...
    **********************************************************************/
    CUDA_HOST_DEVICE void Forward(double lon0, double lat, double lon,
    ...
    **********************************************************************/
    CUDA_HOST_DEVICE void Reverse(double lon0, double x, double y,
    ...
    * scale.
    **********************************************************************/
    CUDA_HOST_DEVICE_INLINE void Forward(double lon0, double lat, double lon,
    ...
    * scale.
    **********************************************************************/
    CUDA_HOST_DEVICE_INLINE void Reverse(double lon0, double x, double y,
